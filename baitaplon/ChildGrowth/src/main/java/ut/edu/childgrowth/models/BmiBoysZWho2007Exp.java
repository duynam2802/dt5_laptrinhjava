...
@Entity
@Table(name = "bmi_boys_z_who_2007_exp")
public class BmiBoysZWho2007Exp {
    ...
    public BmiBoysZWho2007Exp() {
    }

    public BmiBoysZWho2007Exp(Integer month, Double l, Double m, Double s, Double sdneg4, Double sdneg3, Double sdneg2, Double sdneg1, Double sd0, Double sd1, Double sd2, Double sd3, Double sd4) {
        this.month = month;
        this.l = l;
        this.m = m;
        this.s = s;
